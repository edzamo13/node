...
export class createUserCustomer1657076485068 implements MigrationInterface {
    name = 'createUserCustomer1657076485068'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`COMMENT ON COLUMN "product"."createAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "product" ALTER COLUMN "createAt" SET DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`COMMENT ON COLUMN "product"."updateAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "product" ALTER COLUMN "updateAt" SET DEFAULT CURRENT_TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "updateAt" SET DEFAULT CURRENT_TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "user"."id" IS NULL`);
        await queryRunner.query(`ALTER TABLE "product" ALTER COLUMN "updateAt" SET DEFAULT now()`);
        await queryRunner.query(`COMMENT ON COLUMN "product"."updateAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "product" ALTER COLUMN "createAt" SET DEFAULT now()`);
        await queryRunner.query(`COMMENT ON COLUMN "product"."createAt" IS NULL`);
    }
